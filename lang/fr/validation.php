...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute donné apparaît dans une fuite de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Ici tu peux surcharger un message précis pour un champ + une règle,
    | au lieu de le faire dans chaque FormRequest via messages().
    |
    */

    'custom' => [
        'email' => [
            'regex' => 'L\'adresse email doit être complète (ex : nom@exemple.com).',
            'dns' => 'Ce domaine d\'e-mail semble invalide ou inexistant.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace ":attribute" par un nom lisible en français au lieu du nom
    | technique du champ (ex: "nom_boutique" -> "nom de l'entreprise").
    |
    */
    ...
    'attributes' => [
        ...
        'nom_boutique' => 'nom de l\'entreprise',
        'multi_points_vente' => 'nombre de points de vente',
